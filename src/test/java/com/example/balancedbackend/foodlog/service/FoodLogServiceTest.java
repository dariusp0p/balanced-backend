...
class FoodLogServiceTest {
    ...
    void shouldCreateAndReadFoodLog() {
        var request = new FoodLogRequest(null, null, "Greek Yogurt", "2024-03-24", "08:15", null, null, 220, 18, 28, 4, null);
    ...
    void shouldUpdateFoodLog() {
        var created = foodLogService.create(1L, new FoodLogRequest(null, null, "Meal", "2024-03-24", "08:15", null, null, 220, 18, 28, 4, null));

        var updated = foodLogService.update(1L, created.id(),
                new FoodLogRequest(null, null, "Updated Meal", "2024-03-25", "09:10", null, null, 300, 20, 30, 10, null));
    ...
    void shouldPaginateFoodLogs() {
        for (int i = 0; i < 7; i++) {
            foodLogService.create(1L, new FoodLogRequest(null, null, "Meal " + i, "2024-03-24", "08:15", null, null, 100, 1, 2, 3, null));
        }
    ...
    void shouldCalculateStats() {
        foodLogService.create(1L, new FoodLogRequest(null, null, "Meal 1", "2024-03-24", "08:15", null, null, 200, 10, 20, 5, null));
        foodLogService.create(1L, new FoodLogRequest(null, null, "Meal 2", "2024-03-24", "12:30", null, null, 300, 20, 30, 10, null));
    ...
    void shouldReturnOnlyLogsForSpecificDay() {
        foodLogService.create(1L, new FoodLogRequest(null, null, "Meal 1", "2024-03-24", "08:15", null, null, 200, 10, 20, 5, null));
        foodLogService.create(1L, new FoodLogRequest(null, null, "Meal 2", "2024-03-24", "12:30", null, null, 300, 20, 30, 10, null));
        foodLogService.create(1L, new FoodLogRequest(null, null, "Meal 3", "2024-03-25", "09:45", null, null, 150, 8, 18, 3, null));
    ...
    void shouldAssignFoodLogToOwnedGroup() {
        var group = logGroupService.create(1L, new LogGroupRequest("Lunches", null, "2024-03-24", false, 0, 0, 0, 0));

        var created = foodLogService.create(1L,
                new FoodLogRequest(group.id(), null, "Meal", "2024-03-24", "08:15", null, null, 220, 18, 28, 4, null));
    ...
    void shouldRejectGroupFromAnotherUser() {
        var group = logGroupService.create(2L, new LogGroupRequest("Private", null, "2024-03-24", false, 0, 0, 0, 0));
